...
contains the Phase 1 web foundation and Phase 1.5 visual polish: a dark cosmic React
interface, route placeholders, reusable UI primitives, lightweight presentation-only
animation, linting, formatting, and tests. Secure claims and persistence are intentionally
...
- Phase 1.5 is UI polish only. The animated background, interactive chest shimmer, and
  collection progress are decorative previews and do not award or persist cards.
